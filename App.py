    ...
    while(True):
        ...
        while(True):
            try:
                ...
                print("Please Enter Integer for the corresponding choice")
        ...
        if(choice == 1):
            ...
            if(password == ""):
                ...
                while(True):
                    ...
                    if(choice1 == 1):
                        print(f"Amount in your wallet : {users[username][0]}\n")

                    # Updating Expense
                    elif(choice1 == 2):

                        expenseInfo = input("Enter Expense Information: ")
            ...
            if(username == "admin" and password == "admin"):
                while(True):
                    ...
                    if(choice3 == 1):
                        ...
                        print(f"Total Money in App of All Users is: {total}")
                    elif(choice3 == 2):
                        printDetails()
                    elif(choice3 == 3):
                        break
...
# Admin Menu
def adminMenu():
    print("1) Check total amount in app")
...
def registerMember():
    ...
    print("Registration Successfull, Welcome", str(username) + "!")
